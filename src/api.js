...
export const getPicturesWithLocations = (page, lat, lon) =>
  `https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=52b91cab9d9970ca63cf75a911377263&text=dogs&per_page=10&page=${page}&format=json&nojsoncallback=1&lat=${lat}&lon=${lon}`;
